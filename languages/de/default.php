 ...
 * Miscellaneous
 */
$GLOBALS['TL_LANG']['MSC']['strFormArrival']                 = 'Datum und Uhrzeit';
$GLOBALS['TL_LANG']['MSC']['strFormSubmit']                  = 'Verfügbarkeit prüfen';
$GLOBALS['TL_LANG']['MSC']['count']                          = 'Person(en)';
$GLOBALS['TL_LANG']['MSC']['strFormTableCategory']           = 'Tischkategorie wählen';
$GLOBALS['TL_LANG']['MSC']['countError']                     = 'Bitte geben Sie die gewünschte Personenanzahl an.';
$GLOBALS['TL_LANG']['MSC']['notEnoughTablesError']           = 'Nicht genügend Plätze frei für Tischkategorie "%s" in diesem Zeitraum.';
$GLOBALS['TL_LANG']['MSC']['noSeatsForTableCategory']        = 'Keine Plätze frei für Tischkategorie "%s" in diesem Zeitraum.';
$GLOBALS['TL_LANG']['MSC']['notEnoughSeatsForTableCategory'] = 'Nicht genügend Plätze frei für Tischkategorie "%s" in diesem Zeitraum.';
$GLOBALS['TL_LANG']['MSC']['maxCountError']                  = 'Reservierung für Tischkategorie "%s" nicht möglich. Maximal verfügbare Plätze für diesen Zeitraum: %s.';
$GLOBALS['TL_LANG']['MSC']['reservationPossible']            = 'Für den ausgewählten Zeitraum ist eine Reservierung möglich:';
$GLOBALS['TL_LANG']['MSC']['reservationTooLate']             = 'Der nächstmögliche Reservierungszeitpunkt ist nach: "%s".';
$GLOBALS['TL_LANG']['MSC']['reservationNotPossible']         = 'Es ist leider keine Reservierung möglich.';
...
$GLOBALS['TL_LANG']['MSC']['strFormStreet']                  = 'Straße & Hausnr.';
...
$GLOBALS['TL_LANG']['MSC']['tables']                         = 'Personen:';
$GLOBALS['TL_LANG']['MSC']['showTotalOverview']              = '[Übersicht anzeigen]';
$GLOBALS['TL_LANG']['MSC']['seats']                          = 'Sitzplätze';
