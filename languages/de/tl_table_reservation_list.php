...
$GLOBALS['TL_LANG']['tl_table_reservation_list']['copy']          = ['Details duplizieren', 'Reservierungsdetails für Datensatz %s duplizieren'];
$GLOBALS['TL_LANG']['tl_table_reservation_list']['show']          = ['Details anzeigen', 'Reservierungsdetails für Datensatz %s anzeigen'];
$GLOBALS['TL_LANG']['tl_table_reservation_list']['delete']        = ['Reservierung löschen', 'Reservierung %s löschen'];
$GLOBALS['TL_LANG']['tl_table_reservation_list']['deleteConfirm'] = 'Soll die Reservierung #%s wirklich gelöscht werden?';
